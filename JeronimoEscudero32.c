...
//Se crea la función SerieCosenoHiperbolico 
...
int main()
{
    ...
    //Se llama a la función SerieCosenoHiperbolico con los valores de n - 1 (debido a que la serie termina en n = 0) y x como parámetros
    printf( "El valor de cosh(%f) es igual a: %f", x, SerieCosenoHiperbolico( n - 1, x ) );
