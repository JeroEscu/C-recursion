...
int main()
{
    ...
    //Se llama a la función SerieSeno con los valores de n - 1 (debido a que la serie termina en n = 0) y x como parámetros
    printf( "Con %i terminos, sen(%f) es igual a: %f", n, x, SerieSeno( n - 1, x ) );
